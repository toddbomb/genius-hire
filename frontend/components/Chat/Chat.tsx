        ...
        <>
          ...
          >
            {selectedConversation?.messages.length === 0 ? (
              ...
              <div className="sticky top-4 mb-4 mr-2 z-10 flex rounded-xl justify-between bg-[#181817] py-2 px-[10px] text-[13px] text-white dark:border-none dark:bg-[#444654] dark:text-neutral-200 h-12 shadow-lg">
                ...
                <div
                  className="h-[162px] dark:bg-[#343541]"
                  ref={messagesEndRef}
                />
              </>
            )}
