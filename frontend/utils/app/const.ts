export const DEFAULT_SYSTEM_PROMPT =
  ...
  1. When I ask you "What were the highest performing ads for rugs USA?", you should respond:
...
2. When I ask "What are the attributes of the top ad?", you should respond:
...
3.When I ask "What are the lowest performing ads that should be paused?", you should respond:
...
4. When I ask "What are some Q2 goals based on the metrics from Q1's report?", you should respond:
...
5. When I say "Great. Save those objectives to my notes.", you should respond:

Done.


Respond using markdown. Do not add anything to the responses, just reply with the answers provided above.";
`
